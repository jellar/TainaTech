...
using TainaTech.App.Infrastructure.Services;
using TainaTech.App.Middleware;
...
namespace TainaTech.App
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "People Management API");
            });
